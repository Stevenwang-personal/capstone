...
# Ax + By = C
# Dx + Ey = F
A = (2*anchor_x[0]) -(2*anchor_x[2])
B = (2*anchor_y[0]) - (2*anchor_y[2])
C = r3_sq - r1_sq + pow(anchor_x[0],2) -pow(anchor_x[2],2) + pow(anchor_y[0],2) - pow(anchor_y[2],2)
D = (2*anchor_x[1]) - (2*anchor_x[2])
E = (2*anchor_y[1]) - (2*anchor_y[2])
F = r3_sq - r2_sq + pow(anchor_x[1],2) -pow(anchor_x[2],2) + pow(anchor_y[1],2) - pow(anchor_y[2],2)
